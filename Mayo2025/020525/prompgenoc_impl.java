/*
       ...
       Generated on: May 2, 2025 11:20:24.6
...
public final  class prompgenoc_impl extends GXDataArea
{
   ...
   public void renderHtmlOpenForm( )
   {
      ...
      httpContext.AddJavascriptSource("gxcfg.js", "?20255211202536", false, true);
      if ( httpContext.isSpaRequest( ) )
      {
         httpContext.enableOutput();
      }
   ...
   public void sendCloseFormHiddens( )
   {
      ...
      com.kdsproyectos.GxWebStd.gx_hidden_field( httpContext, "vPGMNAME", GXutil.rtrim( AV251Pgmname));
   ...
   public void send_integrity_lvl_hashes3RE10( )
   {
   }
            ...
            if ( !( GXutil.dateCompare(AV128ACMROIFDOC, GXutil.nullDate()) ) )
            {
               if ( ( AV30subtotal_oc.doubleValue() != 0 ) && ( GXutil.strcmp(AV6CNTPGOID, "") != 0 ) )
               {
                  ...
                  else
                  {
                     ...
                     {
                        A15965VALCOMIDA = H03RE8_A15965VALCOMIDA[0] ;
   ...
   public void S172( )
   {
      ...
      /* Using cursor H03RE9 */
      pr_default.execute(7, new Object[] {AV225EstructImpId});
      while ( (pr_default.getStatus(7) != 101) )
      {
         A2875EstructImpId = H03RE9_A2875EstructImpId[0] ;
         A2876EstructImpDsc = H03RE9_A2876EstructImpDsc[0] ;
         n2876EstructImpDsc = H03RE9_n2876EstructImpDsc[0] ;
         A3366EstructImpTip = H03RE9_A3366EstructImpTip[0] ;
         n3366EstructImpTip = H03RE9_n3366EstructImpTip[0] ;
      ...
      pr_default.execute(8, new Object[] {AV225EstructImpId});
      while ( (pr_default.getStatus(8) != 101) )
      {
         A2875EstructImpId = H03RE10_A2875EstructImpId[0] ;
         A458CNTIVAID = H03RE10_A458CNTIVAID[0] ;
         n458CNTIVAID = H03RE10_n458CNTIVAID[0] ;
         A993CNTIVAPRC = H03RE10_A993CNTIVAPRC[0] ;
         n993CNTIVAPRC = H03RE10_n993CNTIVAPRC[0] ;
         A993CNTIVAPRC = H03RE10_A993CNTIVAPRC[0] ;
         n993CNTIVAPRC = H03RE10_n993CNTIVAPRC[0] ;
   ...
   public void S162( )
   {
      ...
      pr_default.execute(9, new Object[] {new Long(AV16CNCIASID), AV125ACMROITDOC, new Long(AV121ACMROINDOC)});
      while ( (pr_default.getStatus(9) != 101) )
      {
         A821ACMROITDOC = H03RE11_A821ACMROITDOC[0] ;
         A822ACMROINDOC = H03RE11_A822ACMROINDOC[0] ;
         A5939CNCIASID = H03RE11_A5939CNCIASID[0] ;
         A827ACMROINP = H03RE11_A827ACMROINP[0] ;
         n827ACMROINP = H03RE11_n827ACMROINP[0] ;
         A826ACMROIQT = H03RE11_A826ACMROIQT[0] ;
         n826ACMROIQT = H03RE11_n826ACMROIQT[0] ;
         A824ACMROILIN = H03RE11_A824ACMROILIN[0] ;
   ...
   public void e143RE2( )
   {
      ...
      {
         AV241GXV1 = 1 ;
         while ( AV241GXV1 <= AV75UploadedFiles.size() )
         {
            AV76FileUploadData = (com.kdsproyectos.SdtFileUploadData)((com.kdsproyectos.SdtFileUploadData)AV75UploadedFiles.elementAt(-1+AV241GXV1));
   ...
   public void S132( )
   {
      ...
      pr_default.execute(10, new Object[] {AV11CNTIVAID});
   ...
   public void e173RE2( )
   {
      ...
      {
         AV244GXLvl592 = (byte)(0) ;
         /* Using cursor H03RE13 */
         pr_default.execute(11, new Object[] {AV8cncdirnom});
         while ( (pr_default.getStatus(11) != 101) )
         {
            A507CNCDIRFBA = H03RE13_A507CNCDIRFBA[0] ;
            n507CNCDIRFBA = H03RE13_n507CNCDIRFBA[0] ;
            A533CNCDIRFSP = H03RE13_A533CNCDIRFSP[0] ;
            n533CNCDIRFSP = H03RE13_n533CNCDIRFSP[0] ;
            A194CNCDIRNOM = H03RE13_A194CNCDIRNOM[0] ;
            n194CNCDIRNOM = H03RE13_n194CNCDIRNOM[0] ;
            A46CNCDIRID = H03RE13_A46CNCDIRID[0] ;
            n46CNCDIRID = H03RE13_n46CNCDIRID[0] ;
            A199CNCDIRRFC = H03RE13_A199CNCDIRRFC[0] ;
            n199CNCDIRRFC = H03RE13_n199CNCDIRRFC[0] ;
            A2882CNCDIRESTIMP = H03RE13_A2882CNCDIRESTIMP[0] ;
            n2882CNCDIRESTIMP = H03RE13_n2882CNCDIRESTIMP[0] ;
            AV244GXLvl592 = (byte)(1) ;
         ...
         if ( AV244GXLvl592 == 0 )
         {
            ...
            pr_default.execute(12, new Object[] {new Long(AV16CNCIASID), AV17CNTDOCID, new Long(AV10VALCOMDOC)});
            while ( (pr_default.getStatus(12) != 101) )
            {
               A15642VALCOMDOC = H03RE14_A15642VALCOMDOC[0] ;
               A20CNTDOCID = H03RE14_A20CNTDOCID[0] ;
               A5939CNCIASID = H03RE14_A5939CNCIASID[0] ;
               A46CNCDIRID = H03RE14_A46CNCDIRID[0] ;
               n46CNCDIRID = H03RE14_n46CNCDIRID[0] ;
               A194CNCDIRNOM = H03RE14_A194CNCDIRNOM[0] ;
               n194CNCDIRNOM = H03RE14_n194CNCDIRNOM[0] ;
               A199CNCDIRRFC = H03RE14_A199CNCDIRRFC[0] ;
               n199CNCDIRRFC = H03RE14_n199CNCDIRRFC[0] ;
               A2882CNCDIRESTIMP = H03RE14_A2882CNCDIRESTIMP[0] ;
               n2882CNCDIRESTIMP = H03RE14_n2882CNCDIRESTIMP[0] ;
               A194CNCDIRNOM = H03RE14_A194CNCDIRNOM[0] ;
               n194CNCDIRNOM = H03RE14_n194CNCDIRNOM[0] ;
               A199CNCDIRRFC = H03RE14_A199CNCDIRRFC[0] ;
               n199CNCDIRRFC = H03RE14_n199CNCDIRRFC[0] ;
      ...
      else
      {
         ...
         pr_default.execute(13, new Object[] {new Long(AV16CNCIASID), AV17CNTDOCID, new Long(AV10VALCOMDOC)});
         while ( (pr_default.getStatus(13) != 101) )
         {
            A15642VALCOMDOC = H03RE15_A15642VALCOMDOC[0] ;
            A20CNTDOCID = H03RE15_A20CNTDOCID[0] ;
            A5939CNCIASID = H03RE15_A5939CNCIASID[0] ;
   ...
   public void S122( )
   {
      ...
      while ( (pr_default.getStatus(14) != 101) )
      {
         ...
         A15643VALCOMPRY = H03RE16_A15643VALCOMPRY[0] ;
         n15643VALCOMPRY = H03RE16_n15643VALCOMPRY[0] ;
         A15647VALCOMMON = H03RE16_A15647VALCOMMON[0] ;
         n15647VALCOMMON = H03RE16_n15647VALCOMMON[0] ;
         A15648VALCOMEST = H03RE16_A15648VALCOMEST[0] ;
         n15648VALCOMEST = H03RE16_n15648VALCOMEST[0] ;
         A15652VALCOMUMT = H03RE16_A15652VALCOMUMT[0] ;
         n15652VALCOMUMT = H03RE16_n15652VALCOMUMT[0] ;
         A2882CNCDIRESTIMP = H03RE16_A2882CNCDIRESTIMP[0] ;
         n2882CNCDIRESTIMP = H03RE16_n2882CNCDIRESTIMP[0] ;
         A15971VALCOMTCAM = H03RE16_A15971VALCOMTCAM[0] ;
         n15971VALCOMTCAM = H03RE16_n15971VALCOMTCAM[0] ;
         A15972VALCOMNOC = H03RE16_A15972VALCOMNOC[0] ;
         n15972VALCOMNOC = H03RE16_n15972VALCOMNOC[0] ;
         A15973VALCOMALME = H03RE16_A15973VALCOMALME[0] ;
         n15973VALCOMALME = H03RE16_n15973VALCOMALME[0] ;
         A15974VALCOMTIVA = H03RE16_A15974VALCOMTIVA[0] ;
         n15974VALCOMTIVA = H03RE16_n15974VALCOMTIVA[0] ;
         A15975VALCOMCPGO = H03RE16_A15975VALCOMCPGO[0] ;
         n15975VALCOMCPGO = H03RE16_n15975VALCOMCPGO[0] ;
         A16310VALCOMINCDTO = H03RE16_A16310VALCOMINCDTO[0] ;
         n16310VALCOMINCDTO = H03RE16_n16310VALCOMINCDTO[0] ;
         A16311VALCOMTIPDTO = H03RE16_A16311VALCOMTIPDTO[0] ;
         n16311VALCOMTIPDTO = H03RE16_n16311VALCOMTIPDTO[0] ;
         A16314VALCOMPORDTOF = H03RE16_A16314VALCOMPORDTOF[0] ;
         n16314VALCOMPORDTOF = H03RE16_n16314VALCOMPORDTOF[0] ;
         A16315VALCOMMTODTOF = H03RE16_A16315VALCOMMTODTOF[0] ;
         n16315VALCOMMTODTOF = H03RE16_n16315VALCOMMTODTOF[0] ;
         A16312VALCOMPORDTON = H03RE16_A16312VALCOMPORDTON[0] ;
         n16312VALCOMPORDTON = H03RE16_n16312VALCOMPORDTON[0] ;
         A16313VALCOMMTODTON = H03RE16_A16313VALCOMMTODTON[0] ;
         n16313VALCOMMTODTON = H03RE16_n16313VALCOMMTODTON[0] ;
         A458CNTIVAID = H03RE16_A458CNTIVAID[0] ;
         n458CNTIVAID = H03RE16_n458CNTIVAID[0] ;
         A46CNCDIRID = H03RE16_A46CNCDIRID[0] ;
         n46CNCDIRID = H03RE16_n46CNCDIRID[0] ;
         A15643VALCOMPRY = H03RE16_A15643VALCOMPRY[0] ;
         n15643VALCOMPRY = H03RE16_n15643VALCOMPRY[0] ;
   ...
   public void S142( )
   {
      ...
      pr_default.execute(15, new Object[] {AV11CNTIVAID});
      while ( (pr_default.getStatus(15) != 101) )
      {
         A458CNTIVAID = H03RE17_A458CNTIVAID[0] ;
         n458CNTIVAID = H03RE17_n458CNTIVAID[0] ;
         A993CNTIVAPRC = H03RE17_A993CNTIVAPRC[0] ;
         n993CNTIVAPRC = H03RE17_n993CNTIVAPRC[0] ;
         AV12CNTIVAPRC = A993CNTIVAPRC ;
         httpContext.ajax_rsp_assign_attri("", false, "AV12CNTIVAPRC", GXutil.ltrim( GXutil.str( AV12CNTIVAPRC, 11, 4)));
         /* Exiting from a For First loop. */
         if (true) break;
      ...
      while ( (pr_default.getStatus(16) != 101) )
      {
         ...
         A15964VALCOMQTOC = H03RE18_A15964VALCOMQTOC[0] ;
         n15964VALCOMQTOC = H03RE18_n15964VALCOMQTOC[0] ;
         A15654VALCOMPRE = H03RE18_A15654VALCOMPRE[0] ;
         n15654VALCOMPRE = H03RE18_n15654VALCOMPRE[0] ;
   ...
   public void S182( )
   {
      ...
      pr_default.execute(17, new Object[] {new Long(AV16CNCIASID), AV17CNTDOCID, new Long(AV10VALCOMDOC)});
      while ( (pr_default.getStatus(17) != 101) )
      {
         A15642VALCOMDOC = H03RE19_A15642VALCOMDOC[0] ;
         A20CNTDOCID = H03RE19_A20CNTDOCID[0] ;
         A5939CNCIASID = H03RE19_A5939CNCIASID[0] ;
         A15968VALCOMTIPAR = H03RE19_A15968VALCOMTIPAR[0] ;
         n15968VALCOMTIPAR = H03RE19_n15968VALCOMTIPAR[0] ;
         A15967VALCOMBLOB_Filetype = A15968VALCOMTIPAR ;
         A15967VALCOMBLOB = H03RE19_A15967VALCOMBLOB[0] ;
         n15967VALCOMBLOB = H03RE19_n15967VALCOMBLOB[0] ;
         A15966VALCOMNMA = H03RE19_A15966VALCOMNMA[0] ;
         n15966VALCOMNMA = H03RE19_n15966VALCOMNMA[0] ;
         A17225VALCOMRUT = H03RE19_A17225VALCOMRUT[0] ;
         n17225VALCOMRUT = H03RE19_n17225VALCOMRUT[0] ;
   ...
   public void S2019( )
   {
      ...
      httpContext.ajax_rsp_assign_attri("", false, "AV170busc", AV170busc);
      new com.kdsproyectos.generatxt(remoteHandle, context).execute( AV251Pgmname, "antes de buscar uuid "+AV165XMLDOCUUID) ;
      ...
      new com.kdsproyectos.generatxt(remoteHandle, context).execute( AV251Pgmname, "antes de comparar uuid "+AV165XMLDOCUUID) ;
      if ( GXutil.strcmp(AV165XMLDOCUUID, "") != 0 )
      {
         ...
         S272 ();
         if (returnInSub) return;
         AV252GXLvl1063 = (byte)(0) ;
         /* Using cursor H03RE20 */
         pr_default.execute(18, new Object[] {AV165XMLDOCUUID});
         while ( (pr_default.getStatus(18) != 101) )
         {
            A909PMUuid = H03RE20_A909PMUuid[0] ;
            n909PMUuid = H03RE20_n909PMUuid[0] ;
            A862PMNumDoc = H03RE20_A862PMNumDoc[0] ;
            A861PMTipoDoc = H03RE20_A861PMTipoDoc[0] ;
            AV252GXLvl1063 = (byte)(1) ;
   ...
   public void S272( )
   {
      ...
      pr_default.execute(19, new Object[] {new Long(AV200PMEmpresa)});
      while ( (pr_default.getStatus(19) != 101) )
      {
         A5939CNCIASID = H03RE21_A5939CNCIASID[0] ;
         A14CNCIASRFC = H03RE21_A14CNCIASRFC[0] ;
         n14CNCIASRFC = H03RE21_n14CNCIASRFC[0] ;
   ...
   {
      /* 'BUSCA RFC' Routine */
      AV254Trfc = DecimalUtil.doubleToDec(GXutil.strSearch( AV169xml, AV170busc, 1)) ;
      AV170busc = "fc=\"" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV170busc", AV170busc);
      AV210cont = GXutil.len( AV170busc) ;
      AV211vini = GXutil.strSearch( AV169xml, AV170busc, (int)(DecimalUtil.decToDouble(AV254Trfc))) ;
      if ( AV211vini != 0 )
      {
   ...
   {
      /* 'BUSCA UUID' Routine */
      AV255Buscid = DecimalUtil.doubleToDec(GXutil.strSearch( AV169xml, AV170busc, 1)) ;
      AV170busc = "UUID=\"" ;
      httpContext.ajax_rsp_assign_attri("", false, "AV170busc", AV170busc);
      AV210cont = GXutil.len( AV170busc) ;
      AV211vini = GXutil.strSearch( AV169xml, AV170busc, (int)(DecimalUtil.decToDouble(AV255Buscid))) ;
      new com.kdsproyectos.generatxt(remoteHandle, context).execute( "subir xml", "adentro de buscar uuid &vini:"+GXutil.str( AV211vini, 10, 0)+" &Buscid:"+GXutil.str( AV255Buscid, 10, 2)) ;
      if ( AV211vini != 0 )
      {
         AV211vini = (long)(AV211vini+AV210cont) ;
         AV212vfin = GXutil.strSearch( AV169xml, "\"", (int)(AV211vini)) ;
   ...
   public void S292( )
   {
      ...
      while ( AV216valini < AV217valfin )
      {
         ...
         AV256Val = DecimalUtil.doubleToDec(GXutil.strSearch( AV169xml, "/>", (int)(AV216valini))) ;
         AV216valini = (long)(DecimalUtil.decToDouble(AV256Val)) ;
         httpContext.ajax_rsp_assign_attri("", false, "AV216valini", GXutil.ltrim( GXutil.str( AV216valini, 10, 0)));
   ...
   private void e293RE10( )
   {
      /* Sfl_3_Load Routine */
      /* Using cursor H03RE22 */
      pr_default.execute(20, new Object[] {new Long(AV16CNCIASID), AV17CNTDOCID, new Long(AV10VALCOMDOC)});
      while ( (pr_default.getStatus(20) != 101) )
      {
         A15642VALCOMDOC = H03RE22_A15642VALCOMDOC[0] ;
         A20CNTDOCID = H03RE22_A20CNTDOCID[0] ;
         A5939CNCIASID = H03RE22_A5939CNCIASID[0] ;
         A15968VALCOMTIPAR = H03RE22_A15968VALCOMTIPAR[0] ;
         n15968VALCOMTIPAR = H03RE22_n15968VALCOMTIPAR[0] ;
         A15967VALCOMBLOB_Filetype = A15968VALCOMTIPAR ;
         A15966VALCOMNMA = H03RE22_A15966VALCOMNMA[0] ;
         n15966VALCOMNMA = H03RE22_n15966VALCOMNMA[0] ;
         A15970VALCOMFECA = H03RE22_A15970VALCOMFECA[0] ;
         n15970VALCOMFECA = H03RE22_n15970VALCOMFECA[0] ;
         A15967VALCOMBLOB = H03RE22_A15967VALCOMBLOB[0] ;
         n15967VALCOMBLOB = H03RE22_n15967VALCOMBLOB[0] ;
         A15969VALCOMUSRA = H03RE22_A15969VALCOMUSRA[0] ;
         n15969VALCOMUSRA = H03RE22_n15969VALCOMUSRA[0] ;
         A15965VALCOMIDA = H03RE22_A15965VALCOMIDA[0] ;
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( Form.getJscriptsrc().item(idxLst)), "?20255211203940", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         ...
         httpContext.AddJavascriptSource("prompgenoc.js", "?20255211203941", false, true);
         httpContext.AddJavascriptSource("Shared/ext/ext-all.js", "", false, true);
         httpContext.AddJavascriptSource("FileUpload/fileupload.min.js", "", false, true);
         httpContext.AddJavascriptSource("gxui/gxui-all.js", "", false, true);
         httpContext.AddJavascriptSource("KDSControls/KDSStylesDatatables/KDSStylesDatatablesRender.js", "", false, true);
   ...
   public void subsflControlProps_22810( )
   {
   ...
   public void subsflControlProps_fel_22810( )
   {
   ...
   public void sendrow_22810( )
   {
      ...
      send_integrity_lvl_hashes3RE10( ) ;
      Sfl_3Container.AddRow(Sfl_3Row);
      nGXsfl_228_idx = (short)(((subSfl_3_Islastpage==1)&&(nGXsfl_228_idx+1>subsfl_3_recordsperpage( )) ? 1 : nGXsfl_228_idx+1)) ;
      sGXsfl_228_idx = GXutil.padl( GXutil.ltrim( GXutil.str( nGXsfl_228_idx, 4, 0)), (short)(4), "0") ;
      subsflControlProps_22810( ) ;
      /* End function sendrow_22810 */
   }
   ...
   public void initializeDynEvents( )
   {
      ...
      setEventMetadata("SFL_3.LOAD","{handler:'e293RE10',iparms:[{av:'A15965VALCOMIDA',fld:'VALCOMIDA',pic:'ZZZZZZZZZ9'},{av:'A5939CNCIASID',fld:'CNCIASID',pic:'ZZZZZZZZZ9'},{av:'AV16CNCIASID',fld:'vCNCIASID',pic:'ZZZZZZZZZ9',hsh:true},{av:'A20CNTDOCID',fld:'CNTDOCID',pic:''},{av:'AV17CNTDOCID',fld:'vCNTDOCID',pic:'',hsh:true},{av:'A15642VALCOMDOC',fld:'VALCOMDOC',pic:'ZZZZZZZZZ9'},{av:'AV10VALCOMDOC',fld:'vVALCOMDOC',pic:'ZZZZZZZZZ9',hsh:true},{av:'A15966VALCOMNMA',fld:'VALCOMNMA',pic:''},{av:'A15970VALCOMFECA',fld:'VALCOMFECA',pic:''},{av:'A15967VALCOMBLOB',fld:'VALCOMBLOB',pic:''},{av:'A15968VALCOMTIPAR',fld:'VALCOMTIPAR',pic:''},{av:'A15969VALCOMUSRA',fld:'VALCOMUSRA',pic:''},{av:'dynavCntpgoid'},{av:'AV6CNTPGOID',fld:'vCNTPGOID',pic:''},{av:'dynavCntivaid'},{av:'AV11CNTIVAID',fld:'vCNTIVAID',pic:''}]");
   ...
   public void initialize( )
   {
      ...
      AV126ACMROIREF = "" ;
      H03RE8_A15965VALCOMIDA = new long[1] ;
      ...
      H03RE9_A458CNTIVAID = new String[] {""} ;
      H03RE9_n458CNTIVAID = new boolean[] {false} ;
      H03RE9_A2875EstructImpId = new String[] {""} ;
      H03RE9_A2876EstructImpDsc = new String[] {""} ;
      H03RE9_n2876EstructImpDsc = new boolean[] {false} ;
      H03RE9_A3366EstructImpTip = new String[] {""} ;
      H03RE9_n3366EstructImpTip = new boolean[] {false} ;
      AV226EstructImpDsc = "" ;
      AV224EstructImpTip = "" ;
      H03RE10_A2875EstructImpId = new String[] {""} ;
      H03RE10_A458CNTIVAID = new String[] {""} ;
      H03RE10_n458CNTIVAID = new boolean[] {false} ;
      H03RE10_A993CNTIVAPRC = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE10_n993CNTIVAPRC = new boolean[] {false} ;
      AV228estcntivaid = "" ;
      AV229estCNTIVAPRC = DecimalUtil.ZERO ;
      H03RE11_A20CNTDOCID = new String[] {""} ;
      H03RE11_A823ACMROIDOC = new long[1] ;
      H03RE11_A821ACMROITDOC = new String[] {""} ;
      H03RE11_A822ACMROINDOC = new long[1] ;
      H03RE11_A5939CNCIASID = new long[1] ;
      H03RE11_A827ACMROINP = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE11_n827ACMROINP = new boolean[] {false} ;
      H03RE11_A826ACMROIQT = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE11_n826ACMROIQT = new boolean[] {false} ;
      H03RE11_A824ACMROILIN = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      ...
      H03RE13_A507CNCDIRFBA = new java.util.Date[] {GXutil.nullDate()} ;
      H03RE13_n507CNCDIRFBA = new boolean[] {false} ;
      H03RE13_A533CNCDIRFSP = new java.util.Date[] {GXutil.nullDate()} ;
      H03RE13_n533CNCDIRFSP = new boolean[] {false} ;
      H03RE13_A194CNCDIRNOM = new String[] {""} ;
      H03RE13_n194CNCDIRNOM = new boolean[] {false} ;
      H03RE13_A46CNCDIRID = new long[1] ;
      H03RE13_n46CNCDIRID = new boolean[] {false} ;
      H03RE13_A199CNCDIRRFC = new String[] {""} ;
      H03RE13_n199CNCDIRRFC = new boolean[] {false} ;
      H03RE13_A2882CNCDIRESTIMP = new String[] {""} ;
      H03RE13_n2882CNCDIRESTIMP = new boolean[] {false} ;
      H03RE14_A15642VALCOMDOC = new long[1] ;
      H03RE14_A20CNTDOCID = new String[] {""} ;
      H03RE14_A5939CNCIASID = new long[1] ;
      H03RE14_A46CNCDIRID = new long[1] ;
      H03RE14_n46CNCDIRID = new boolean[] {false} ;
      H03RE14_A194CNCDIRNOM = new String[] {""} ;
      H03RE14_n194CNCDIRNOM = new boolean[] {false} ;
      H03RE14_A199CNCDIRRFC = new String[] {""} ;
      H03RE14_n199CNCDIRRFC = new boolean[] {false} ;
      H03RE14_A2882CNCDIRESTIMP = new String[] {""} ;
      H03RE14_n2882CNCDIRESTIMP = new boolean[] {false} ;
      H03RE15_A15642VALCOMDOC = new long[1] ;
      H03RE15_A20CNTDOCID = new String[] {""} ;
      H03RE15_A5939CNCIASID = new long[1] ;
      ...
      H03RE16_A15650VALCOMLIN = new long[1] ;
      ...
      H03RE16_A15643VALCOMPRY = new String[] {""} ;
      H03RE16_n15643VALCOMPRY = new boolean[] {false} ;
      H03RE16_A15647VALCOMMON = new String[] {""} ;
      H03RE16_n15647VALCOMMON = new boolean[] {false} ;
      H03RE16_A15648VALCOMEST = new String[] {""} ;
      H03RE16_n15648VALCOMEST = new boolean[] {false} ;
      H03RE16_A15652VALCOMUMT = new String[] {""} ;
      H03RE16_n15652VALCOMUMT = new boolean[] {false} ;
      H03RE16_A2882CNCDIRESTIMP = new String[] {""} ;
      H03RE16_n2882CNCDIRESTIMP = new boolean[] {false} ;
      H03RE16_A15971VALCOMTCAM = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE16_n15971VALCOMTCAM = new boolean[] {false} ;
      H03RE16_A15972VALCOMNOC = new long[1] ;
      H03RE16_n15972VALCOMNOC = new boolean[] {false} ;
      H03RE16_A15973VALCOMALME = new String[] {""} ;
      H03RE16_n15973VALCOMALME = new boolean[] {false} ;
      H03RE16_A15974VALCOMTIVA = new String[] {""} ;
      H03RE16_n15974VALCOMTIVA = new boolean[] {false} ;
      H03RE16_A15975VALCOMCPGO = new String[] {""} ;
      H03RE16_n15975VALCOMCPGO = new boolean[] {false} ;
      H03RE16_A16310VALCOMINCDTO = new String[] {""} ;
      H03RE16_n16310VALCOMINCDTO = new boolean[] {false} ;
      H03RE16_A16311VALCOMTIPDTO = new String[] {""} ;
      H03RE16_n16311VALCOMTIPDTO = new boolean[] {false} ;
      H03RE16_A16314VALCOMPORDTOF = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE16_n16314VALCOMPORDTOF = new boolean[] {false} ;
      H03RE16_A16315VALCOMMTODTOF = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE16_n16315VALCOMMTODTOF = new boolean[] {false} ;
      H03RE16_A16312VALCOMPORDTON = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE16_n16312VALCOMPORDTON = new boolean[] {false} ;
      H03RE16_A16313VALCOMMTODTON = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE16_n16313VALCOMMTODTON = new boolean[] {false} ;
      H03RE16_A458CNTIVAID = new String[] {""} ;
      H03RE16_n458CNTIVAID = new boolean[] {false} ;
      AV15VALCOMMON = "" ;
      H03RE17_A458CNTIVAID = new String[] {""} ;
      H03RE17_n458CNTIVAID = new boolean[] {false} ;
      H03RE17_A993CNTIVAPRC = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE17_n993CNTIVAPRC = new boolean[] {false} ;
      ...
      H03RE18_A15964VALCOMQTOC = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE18_n15964VALCOMQTOC = new boolean[] {false} ;
      H03RE18_A15654VALCOMPRE = new java.math.BigDecimal[] {DecimalUtil.ZERO} ;
      H03RE18_n15654VALCOMPRE = new boolean[] {false} ;
      ...
      H03RE19_A15965VALCOMIDA = new long[1] ;
      H03RE19_A15642VALCOMDOC = new long[1] ;
      H03RE19_A20CNTDOCID = new String[] {""} ;
      H03RE19_A5939CNCIASID = new long[1] ;
      H03RE19_A15968VALCOMTIPAR = new String[] {""} ;
      H03RE19_n15968VALCOMTIPAR = new boolean[] {false} ;
      H03RE19_A15967VALCOMBLOB = new String[] {""} ;
      H03RE19_n15967VALCOMBLOB = new boolean[] {false} ;
      H03RE19_A15966VALCOMNMA = new String[] {""} ;
      H03RE19_n15966VALCOMNMA = new boolean[] {false} ;
      H03RE19_A17225VALCOMRUT = new String[] {""} ;
      H03RE19_n17225VALCOMRUT = new boolean[] {false} ;
      ...
      AV188id = "" ;
      AV195Estatus = "" ;
      H03RE20_A860PMEmpresa = new long[1] ;
      H03RE20_A909PMUuid = new String[] {""} ;
      H03RE20_n909PMUuid = new boolean[] {false} ;
      H03RE20_A862PMNumDoc = new long[1] ;
      H03RE20_A861PMTipoDoc = new String[] {""} ;
      AV197PMTipodoc2 = "" ;
      AV198auxCadena = "" ;
      H03RE21_A5939CNCIASID = new long[1] ;
      H03RE21_A14CNCIASRFC = new String[] {""} ;
      H03RE21_n14CNCIASRFC = new boolean[] {false} ;
      AV254Trfc = DecimalUtil.ZERO ;
      AV255Buscid = DecimalUtil.ZERO ;
      AV256Val = DecimalUtil.ZERO ;
      ...
      H03RE22_A15642VALCOMDOC = new long[1] ;
      H03RE22_A20CNTDOCID = new String[] {""} ;
      H03RE22_A5939CNCIASID = new long[1] ;
      H03RE22_A15968VALCOMTIPAR = new String[] {""} ;
      H03RE22_n15968VALCOMTIPAR = new boolean[] {false} ;
      H03RE22_A15966VALCOMNMA = new String[] {""} ;
      H03RE22_n15966VALCOMNMA = new boolean[] {false} ;
      H03RE22_A15970VALCOMFECA = new java.util.Date[] {GXutil.nullDate()} ;
      H03RE22_n15970VALCOMFECA = new boolean[] {false} ;
      H03RE22_A15967VALCOMBLOB = new String[] {""} ;
      H03RE22_n15967VALCOMBLOB = new boolean[] {false} ;
      H03RE22_A15969VALCOMUSRA = new String[] {""} ;
      H03RE22_n15969VALCOMUSRA = new boolean[] {false} ;
      H03RE22_A15965VALCOMIDA = new long[1] ;
      ...
      pr_default = new DataStoreProvider(context, remoteHandle, new com.kdsproyectos.prompgenoc__default(),
         new Object[] {
            ...
            , new Object[] {
            H03RE8_A15965VALCOMIDA, H03RE8_A15642VALCOMDOC, H03RE8_A20CNTDOCID, H03RE8_A5939CNCIASID
            }
            , new Object[] {
            H03RE9_A458CNTIVAID, H03RE9_A2875EstructImpId, H03RE9_A2876EstructImpDsc, H03RE9_n2876EstructImpDsc, H03RE9_A3366EstructImpTip, H03RE9_n3366EstructImpTip
            }
            , new Object[] {
            H03RE10_A2875EstructImpId, H03RE10_A458CNTIVAID, H03RE10_A993CNTIVAPRC, H03RE10_n993CNTIVAPRC
            }
            , new Object[] {
            H03RE11_A20CNTDOCID, H03RE11_A823ACMROIDOC, H03RE11_A821ACMROITDOC, H03RE11_A822ACMROINDOC, H03RE11_A5939CNCIASID, H03RE11_A827ACMROINP, H03RE11_n827ACMROINP, H03RE11_A826ACMROIQT, H03RE11_n826ACMROIQT, H03RE11_A824ACMROILIN
            }
            , new Object[] {
            H03RE12_A458CNTIVAID, H03RE12_A993CNTIVAPRC, H03RE12_n993CNTIVAPRC
            }
            , new Object[] {
            H03RE13_A507CNCDIRFBA, H03RE13_n507CNCDIRFBA, H03RE13_A533CNCDIRFSP, H03RE13_n533CNCDIRFSP, H03RE13_A194CNCDIRNOM, H03RE13_n194CNCDIRNOM, H03RE13_A46CNCDIRID, H03RE13_A199CNCDIRRFC, H03RE13_n199CNCDIRRFC, H03RE13_A2882CNCDIRESTIMP,
            H03RE13_n2882CNCDIRESTIMP
            }
            , new Object[] {
            H03RE14_A15642VALCOMDOC, H03RE14_A20CNTDOCID, H03RE14_A5939CNCIASID, H03RE14_A46CNCDIRID, H03RE14_n46CNCDIRID, H03RE14_A194CNCDIRNOM, H03RE14_n194CNCDIRNOM, H03RE14_A199CNCDIRRFC, H03RE14_n199CNCDIRRFC, H03RE14_A2882CNCDIRESTIMP,
            H03RE14_n2882CNCDIRESTIMP
            }
            , new Object[] {
            H03RE15_A15642VALCOMDOC, H03RE15_A20CNTDOCID, H03RE15_A5939CNCIASID, H03RE15_A46CNCDIRID, H03RE15_n46CNCDIRID, H03RE15_A194CNCDIRNOM, H03RE15_n194CNCDIRNOM, H03RE15_A199CNCDIRRFC, H03RE15_n199CNCDIRRFC
            }
            , new Object[] {
            H03RE16_A15650VALCOMLIN, H03RE16_A15642VALCOMDOC, H03RE16_A20CNTDOCID, H03RE16_A5939CNCIASID, H03RE16_A46CNCDIRID, H03RE16_n46CNCDIRID, H03RE16_A194CNCDIRNOM, H03RE16_n194CNCDIRNOM, H03RE16_A199CNCDIRRFC, H03RE16_n199CNCDIRRFC,
            H03RE16_A15643VALCOMPRY, H03RE16_n15643VALCOMPRY, H03RE16_A15647VALCOMMON, H03RE16_n15647VALCOMMON, H03RE16_A15648VALCOMEST, H03RE16_n15648VALCOMEST, H03RE16_A15652VALCOMUMT, H03RE16_n15652VALCOMUMT, H03RE16_A2882CNCDIRESTIMP, H03RE16_n2882CNCDIRESTIMP,
            H03RE16_A15971VALCOMTCAM, H03RE16_n15971VALCOMTCAM, H03RE16_A15972VALCOMNOC, H03RE16_n15972VALCOMNOC, H03RE16_A15973VALCOMALME, H03RE16_n15973VALCOMALME, H03RE16_A15974VALCOMTIVA, H03RE16_n15974VALCOMTIVA, H03RE16_A15975VALCOMCPGO, H03RE16_n15975VALCOMCPGO,
            H03RE16_A16310VALCOMINCDTO, H03RE16_n16310VALCOMINCDTO, H03RE16_A16311VALCOMTIPDTO, H03RE16_n16311VALCOMTIPDTO, H03RE16_A16314VALCOMPORDTOF, H03RE16_n16314VALCOMPORDTOF, H03RE16_A16315VALCOMMTODTOF, H03RE16_n16315VALCOMMTODTOF, H03RE16_A16312VALCOMPORDTON, H03RE16_n16312VALCOMPORDTON,
            H03RE16_A16313VALCOMMTODTON, H03RE16_n16313VALCOMMTODTON, H03RE16_A458CNTIVAID, H03RE16_n458CNTIVAID
            }
            , new Object[] {
            H03RE17_A458CNTIVAID, H03RE17_A993CNTIVAPRC, H03RE17_n993CNTIVAPRC
            }
            , new Object[] {
            H03RE18_A15650VALCOMLIN, H03RE18_A15642VALCOMDOC, H03RE18_A20CNTDOCID, H03RE18_A5939CNCIASID, H03RE18_A15964VALCOMQTOC, H03RE18_n15964VALCOMQTOC, H03RE18_A15654VALCOMPRE, H03RE18_n15654VALCOMPRE
            }
            , new Object[] {
            H03RE19_A15965VALCOMIDA, H03RE19_A15642VALCOMDOC, H03RE19_A20CNTDOCID, H03RE19_A5939CNCIASID, H03RE19_A15968VALCOMTIPAR, H03RE19_n15968VALCOMTIPAR, H03RE19_A15967VALCOMBLOB, H03RE19_n15967VALCOMBLOB, H03RE19_A15966VALCOMNMA, H03RE19_n15966VALCOMNMA,
            H03RE19_A17225VALCOMRUT, H03RE19_n17225VALCOMRUT
            }
            , new Object[] {
            H03RE20_A860PMEmpresa, H03RE20_A909PMUuid, H03RE20_n909PMUuid, H03RE20_A862PMNumDoc, H03RE20_A861PMTipoDoc
            }
            , new Object[] {
            H03RE21_A5939CNCIASID, H03RE21_A14CNCIASRFC, H03RE21_n14CNCIASRFC
            }
            , new Object[] {
            H03RE22_A15642VALCOMDOC, H03RE22_A20CNTDOCID, H03RE22_A5939CNCIASID, H03RE22_A15968VALCOMTIPAR, H03RE22_n15968VALCOMTIPAR, H03RE22_A15966VALCOMNMA, H03RE22_n15966VALCOMNMA, H03RE22_A15970VALCOMFECA, H03RE22_n15970VALCOMFECA, H03RE22_A15967VALCOMBLOB,
            H03RE22_n15967VALCOMBLOB, H03RE22_A15969VALCOMUSRA, H03RE22_n15969VALCOMUSRA, H03RE22_A15965VALCOMIDA
            }
         }
      );
      AV251Pgmname = "prompgenoc" ;
   ...
   private byte AV244GXLvl592 ;
   private byte AV252GXLvl1063 ;
   ...
   private java.math.BigDecimal AV254Trfc ;
   private java.math.BigDecimal AV255Buscid ;
   private java.math.BigDecimal AV256Val ;
   ...
   private long[] H03RE8_A15965VALCOMIDA ;
   private long[] H03RE8_A15642VALCOMDOC ;
   private String[] H03RE8_A20CNTDOCID ;
   private long[] H03RE8_A5939CNCIASID ;
   private String[] H03RE9_A458CNTIVAID ;
   private boolean[] H03RE9_n458CNTIVAID ;
   private String[] H03RE9_A2875EstructImpId ;
   private String[] H03RE9_A2876EstructImpDsc ;
   private boolean[] H03RE9_n2876EstructImpDsc ;
   private String[] H03RE9_A3366EstructImpTip ;
   private boolean[] H03RE9_n3366EstructImpTip ;
   private String[] H03RE10_A2875EstructImpId ;
   private String[] H03RE10_A458CNTIVAID ;
   private boolean[] H03RE10_n458CNTIVAID ;
   private java.math.BigDecimal[] H03RE10_A993CNTIVAPRC ;
   private boolean[] H03RE10_n993CNTIVAPRC ;
   private String[] H03RE11_A20CNTDOCID ;
   private long[] H03RE11_A823ACMROIDOC ;
   private String[] H03RE11_A821ACMROITDOC ;
   private long[] H03RE11_A822ACMROINDOC ;
   private long[] H03RE11_A5939CNCIASID ;
   private java.math.BigDecimal[] H03RE11_A827ACMROINP ;
   private boolean[] H03RE11_n827ACMROINP ;
   private java.math.BigDecimal[] H03RE11_A826ACMROIQT ;
   private boolean[] H03RE11_n826ACMROIQT ;
   private java.math.BigDecimal[] H03RE11_A824ACMROILIN ;
   ...
   private java.util.Date[] H03RE13_A507CNCDIRFBA ;
   private boolean[] H03RE13_n507CNCDIRFBA ;
   private java.util.Date[] H03RE13_A533CNCDIRFSP ;
   private boolean[] H03RE13_n533CNCDIRFSP ;
   private String[] H03RE13_A194CNCDIRNOM ;
   private boolean[] H03RE13_n194CNCDIRNOM ;
   private long[] H03RE13_A46CNCDIRID ;
   private boolean[] H03RE13_n46CNCDIRID ;
   private String[] H03RE13_A199CNCDIRRFC ;
   private boolean[] H03RE13_n199CNCDIRRFC ;
   private String[] H03RE13_A2882CNCDIRESTIMP ;
   private boolean[] H03RE13_n2882CNCDIRESTIMP ;
   private long[] H03RE14_A15642VALCOMDOC ;
   private String[] H03RE14_A20CNTDOCID ;
   private long[] H03RE14_A5939CNCIASID ;
   private long[] H03RE14_A46CNCDIRID ;
   private boolean[] H03RE14_n46CNCDIRID ;
   private String[] H03RE14_A194CNCDIRNOM ;
   private boolean[] H03RE14_n194CNCDIRNOM ;
   private String[] H03RE14_A199CNCDIRRFC ;
   private boolean[] H03RE14_n199CNCDIRRFC ;
   private String[] H03RE14_A2882CNCDIRESTIMP ;
   private boolean[] H03RE14_n2882CNCDIRESTIMP ;
   private long[] H03RE15_A15642VALCOMDOC ;
   private String[] H03RE15_A20CNTDOCID ;
   private long[] H03RE15_A5939CNCIASID ;
   ...
   private long[] H03RE16_A15650VALCOMLIN ;
   ...
   private String[] H03RE16_A15643VALCOMPRY ;
   private boolean[] H03RE16_n15643VALCOMPRY ;
   private String[] H03RE16_A15647VALCOMMON ;
   private boolean[] H03RE16_n15647VALCOMMON ;
   private String[] H03RE16_A15648VALCOMEST ;
   private boolean[] H03RE16_n15648VALCOMEST ;
   private String[] H03RE16_A15652VALCOMUMT ;
   private boolean[] H03RE16_n15652VALCOMUMT ;
   private String[] H03RE16_A2882CNCDIRESTIMP ;
   private boolean[] H03RE16_n2882CNCDIRESTIMP ;
   private java.math.BigDecimal[] H03RE16_A15971VALCOMTCAM ;
   private boolean[] H03RE16_n15971VALCOMTCAM ;
   private long[] H03RE16_A15972VALCOMNOC ;
   private boolean[] H03RE16_n15972VALCOMNOC ;
   private String[] H03RE16_A15973VALCOMALME ;
   private boolean[] H03RE16_n15973VALCOMALME ;
   private String[] H03RE16_A15974VALCOMTIVA ;
   private boolean[] H03RE16_n15974VALCOMTIVA ;
   private String[] H03RE16_A15975VALCOMCPGO ;
   private boolean[] H03RE16_n15975VALCOMCPGO ;
   private String[] H03RE16_A16310VALCOMINCDTO ;
   private boolean[] H03RE16_n16310VALCOMINCDTO ;
   private String[] H03RE16_A16311VALCOMTIPDTO ;
   private boolean[] H03RE16_n16311VALCOMTIPDTO ;
   private java.math.BigDecimal[] H03RE16_A16314VALCOMPORDTOF ;
   private boolean[] H03RE16_n16314VALCOMPORDTOF ;
   private java.math.BigDecimal[] H03RE16_A16315VALCOMMTODTOF ;
   private boolean[] H03RE16_n16315VALCOMMTODTOF ;
   private java.math.BigDecimal[] H03RE16_A16312VALCOMPORDTON ;
   private boolean[] H03RE16_n16312VALCOMPORDTON ;
   private java.math.BigDecimal[] H03RE16_A16313VALCOMMTODTON ;
   private boolean[] H03RE16_n16313VALCOMMTODTON ;
   private String[] H03RE16_A458CNTIVAID ;
   private boolean[] H03RE16_n458CNTIVAID ;
   private String[] H03RE17_A458CNTIVAID ;
   private boolean[] H03RE17_n458CNTIVAID ;
   private java.math.BigDecimal[] H03RE17_A993CNTIVAPRC ;
   private boolean[] H03RE17_n993CNTIVAPRC ;
   ...
   private java.math.BigDecimal[] H03RE18_A15964VALCOMQTOC ;
   private boolean[] H03RE18_n15964VALCOMQTOC ;
   private java.math.BigDecimal[] H03RE18_A15654VALCOMPRE ;
   private boolean[] H03RE18_n15654VALCOMPRE ;
   private long[] H03RE19_A15965VALCOMIDA ;
   private long[] H03RE19_A15642VALCOMDOC ;
   private String[] H03RE19_A20CNTDOCID ;
   private long[] H03RE19_A5939CNCIASID ;
   private String[] H03RE19_A15968VALCOMTIPAR ;
   private boolean[] H03RE19_n15968VALCOMTIPAR ;
   private String[] H03RE19_A15967VALCOMBLOB ;
   private boolean[] H03RE19_n15967VALCOMBLOB ;
   private String[] H03RE19_A15966VALCOMNMA ;
   private boolean[] H03RE19_n15966VALCOMNMA ;
   private String[] H03RE19_A17225VALCOMRUT ;
   private boolean[] H03RE19_n17225VALCOMRUT ;
   private long[] H03RE20_A860PMEmpresa ;
   private String[] H03RE20_A909PMUuid ;
   private boolean[] H03RE20_n909PMUuid ;
   private long[] H03RE20_A862PMNumDoc ;
   private String[] H03RE20_A861PMTipoDoc ;
   private long[] H03RE21_A5939CNCIASID ;
   private String[] H03RE21_A14CNCIASRFC ;
   private boolean[] H03RE21_n14CNCIASRFC ;
   private long[] H03RE22_A15642VALCOMDOC ;
   private String[] H03RE22_A20CNTDOCID ;
   private long[] H03RE22_A5939CNCIASID ;
   private String[] H03RE22_A15968VALCOMTIPAR ;
   private boolean[] H03RE22_n15968VALCOMTIPAR ;
   private String[] H03RE22_A15966VALCOMNMA ;
   private boolean[] H03RE22_n15966VALCOMNMA ;
   private java.util.Date[] H03RE22_A15970VALCOMFECA ;
   private boolean[] H03RE22_n15970VALCOMFECA ;
   private String[] H03RE22_A15967VALCOMBLOB ;
   private boolean[] H03RE22_n15967VALCOMBLOB ;
   private String[] H03RE22_A15969VALCOMUSRA ;
   private boolean[] H03RE22_n15969VALCOMUSRA ;
   private long[] H03RE22_A15965VALCOMIDA ;
...
final  class prompgenoc__default extends DataStoreHelperBase implements ILocalDataStoreHelper
{
   public Cursor[] getCursors( )
   {
      return new Cursor[] {
         ...
         ,new ForEachCursor("H03RE8", "SELECT VALCOMIDA, VALCOMDOC, CNTDOCID, CNCIASID FROM VALCOM2 WHERE (CNCIASID = ? and CNTDOCID = ( ?) and VALCOMDOC = ?) AND (VALCOMIDA <> 0) ORDER BY CNCIASID, CNTDOCID, VALCOMDOC  LIMIT 1",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H03RE9", "SELECT CNTIVAID, EstructImpId, EstructImpDsc, EstructImpTip FROM EstrucImp WHERE EstructImpId = ( ?) ORDER BY EstructImpId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE10", "SELECT T1.EstructImpId, T1.CNTIVAID, T2.CNTIVAPRC FROM (EstrucImp T1 INNER JOIN CNTIVA T2 ON T2.CNTIVAID = T1.CNTIVAID) WHERE T1.EstructImpId = ( ?) ORDER BY T1.EstructImpId ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE11", "SELECT CNTDOCID, ACMROIDOC, ACMROITDOC, ACMROINDOC, CNCIASID, ACMROINP, ACMROIQT, ACMROILIN FROM ACMROI WHERE CNCIASID = ? and ACMROITDOC = ( ?) and ACMROINDOC = ? ORDER BY CNCIASID, ACMROITDOC, ACMROINDOC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE12", "SELECT CNTIVAID, CNTIVAPRC FROM CNTIVA WHERE CNTIVAID = ( ?) ORDER BY CNTIVAID ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H03RE13", "SELECT CNCDIRFBA, CNCDIRFSP, CNCDIRNOM, CNCDIRID, CNCDIRRFC, CNCDIRESTIMP FROM CNCDIR WHERE (CNCDIRFSP = DATE '00010101') AND (CNCDIRFBA = DATE '00010101') AND (CNCDIRNOM = ( ?)) ORDER BY CNCDIRID ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE14", "SELECT T1.VALCOMDOC, T1.CNTDOCID, T1.CNCIASID, T1.CNCDIRID, T2.CNCDIRNOM, T2.CNCDIRRFC, T2.CNCDIRESTIMP FROM (VALCOM T1 LEFT JOIN CNCDIR T2 ON T2.CNCDIRID = T1.CNCDIRID) WHERE T1.CNCIASID = ? and T1.CNTDOCID = ( ?) and T1.VALCOMDOC = ? ORDER BY T1.CNCIASID, T1.CNTDOCID, T1.VALCOMDOC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H03RE15", "SELECT T1.VALCOMDOC, T1.CNTDOCID, T1.CNCIASID, T1.CNCDIRID, T2.CNCDIRNOM, T2.CNCDIRRFC FROM (VALCOM T1 LEFT JOIN CNCDIR T2 ON T2.CNCDIRID = T1.CNCDIRID) WHERE T1.CNCIASID = ? and T1.CNTDOCID = ( ?) and T1.VALCOMDOC = ? ORDER BY T1.CNCIASID, T1.CNTDOCID, T1.VALCOMDOC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H03RE16", "SELECT T1.VALCOMLIN, T1.VALCOMDOC, T1.CNTDOCID, T1.CNCIASID, T2.CNCDIRID, T3.CNCDIRNOM, T3.CNCDIRRFC, T2.VALCOMPRY, T2.VALCOMMON, T2.VALCOMEST, T1.VALCOMUMT, T3.CNCDIRESTIMP, T2.VALCOMTCAM, T2.VALCOMNOC, T2.VALCOMALME, T2.VALCOMTIVA, T2.VALCOMCPGO, T2.VALCOMINCDTO, T2.VALCOMTIPDTO, T2.VALCOMPORDTOF, T2.VALCOMMTODTOF, T2.VALCOMPORDTON, T2.VALCOMMTODTON, T3.CNTIVAID FROM ((VALCOM1 T1 INNER JOIN VALCOM T2 ON T2.CNCIASID = T1.CNCIASID AND T2.CNTDOCID = T1.CNTDOCID AND T2.VALCOMDOC = T1.VALCOMDOC) LEFT JOIN CNCDIR T3 ON T3.CNCDIRID = T2.CNCDIRID) WHERE T1.CNCIASID = ? and T1.CNTDOCID = ( ?) and T1.VALCOMDOC = ? ORDER BY T1.CNCIASID, T1.CNTDOCID, T1.VALCOMDOC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE17", "SELECT CNTIVAID, CNTIVAPRC FROM CNTIVA WHERE CNTIVAID = ( ?) ORDER BY CNTIVAID ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H03RE18", "SELECT VALCOMLIN, VALCOMDOC, CNTDOCID, CNCIASID, VALCOMQTOC, VALCOMPRE FROM VALCOM1 WHERE CNCIASID = ? and CNTDOCID = ( ?) and VALCOMDOC = ? ORDER BY CNCIASID, CNTDOCID, VALCOMDOC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE19", "SELECT VALCOMIDA, VALCOMDOC, CNTDOCID, CNCIASID, VALCOMTIPAR, VALCOMBLOB, VALCOMNMA, VALCOMRUT FROM VALCOM2 WHERE CNCIASID = ? and CNTDOCID = ( ?) and VALCOMDOC = ? ORDER BY CNCIASID, CNTDOCID, VALCOMDOC ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE20", "SELECT PMEmpresa, PMUuid, PMNumDoc, PMTipoDoc FROM PMCuentaXPag WHERE PMUuid = ( ?) ORDER BY PMEmpresa, PMTipoDoc, PMNumDoc ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
         ,new ForEachCursor("H03RE21", "SELECT CNCIASID, CNCIASRFC FROM CNCIAS WHERE CNCIASID = ? ORDER BY CNCIASID ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,1,0,true )
         ,new ForEachCursor("H03RE22", "SELECT VALCOMDOC, CNTDOCID, CNCIASID, VALCOMTIPAR, VALCOMNMA, VALCOMFECA, VALCOMBLOB, VALCOMUSRA, VALCOMIDA FROM VALCOM2 WHERE CNCIASID = ? and CNTDOCID = ( ?) and VALCOMDOC = ? ORDER BY CNCIASID, CNTDOCID, VALCOMDOC, VALCOMIDA ",false, GX_NOMASK + GX_MASKLOOPLOCK, false, this,100,0,false )
      };
   }
